...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="FlagKit",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@property (nonatomic, readonly, strong) NSImage * _Nonnull originalImage;
...
@interface NSImage (SWIFT_EXTENSION(FlagKit))
- (nullable instancetype)initWithFlagImageWithCountryCode:(NSString * _Nonnull)countryCode SWIFT_UNAVAILABLE_MSG("FlagKit no longer has default styling of flags, create a Flag model and generate an image with the specified style");
@end
